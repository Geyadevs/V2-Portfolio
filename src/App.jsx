...
const PROJECTS = [
  { title:"DesignOS",  desc:"A full-featured design system platform with live component preview, token management, and multi-theme export. Used by 3 enterprise clients.", tech:["React","Storybook"], color:"#00C2FF", icon:"◈" },
  { title:"Kartify",   desc:"High-performance e-commerce storefront with SSR, dynamic product filtering, cart logic, and Stripe checkout. Scores 97/100 on Lighthouse.",   tech:["Next.js","Stripe"],   color:"#7B61FF", icon:"◉" },
  { title:"DataPulse", desc:"Real-time analytics dashboard with customizable widget grid, WebSocket data feeds, and CSV export. Built for a fintech startup.",              tech:["Vue.js","D3.js"],     color:"#00E5A0", icon:"◎" },
  { title:"FlowForge", desc:"Open-source drag-and-drop automation builder with conditional logic, webhook triggers, and a visual node editor using React Flow.",           tech:["React Flow","Node.js"],color:"#FF6B6B", icon:"◆" },
];

const SKILL_GROUPS = [
  { label:"Languages & Frameworks", items:["JavaScript","TypeScript","React","Vue.js","Next.js"] },
  { label:"Styling & Design",       items:["Tailwind CSS","SCSS","Framer Motion","Figma","Storybook"] },
  { label:"Tools & Workflow",       items:["Git","Vite","Vercel","Cypress","Jest"] },
  { label:"Standards",              items:["WCAG / a11y"] },
];
...
const TECH_ICONS = {
  ...
  "Jest":         <svg viewBox="0 0 32 32" width="14" height="14"><circle cx="16" cy="16" r="16" fill="#C21325"/><path d="M16 8a8 8 0 100 16A8 8 0 0016 8zm0 14a6 6 0 110-12 6 6 0 010 12zm-1-9h2v4h-2zm0 5h2v2h-2z" fill="#fff"/></svg>,
